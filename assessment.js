(function() {
    'use strict';
    const userNameInput = document.getElementById('user-name');         // 入力されたユーザ名
    const assessmentButton = document.getElementById('assessment');     // 診断ボタン
    const resultDivided = document.getElementById('result-area');       // 診断結果
    ...
    console.assert(
        ...
        '入力が同じ場合に正しい診断結果を出力する処理が正しくありません。'
    );
